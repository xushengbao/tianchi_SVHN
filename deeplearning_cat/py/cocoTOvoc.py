...
def convert_boxshape(size, box):
    ...
    #x=box[0]
    #y=box[1]
    x = box[0]  #标注区域X坐标 left
    y = box[1]  #标注区域Y坐标 top
    w = box[2]   # 标注区域宽度 width
    h = box[3]   #标注区域高度 height
...
if __name__ == "__main__":
    ...
    Convert_coco_to_voc("D:/data/SVHN/train_val/train+val_annos.json","D:/data/SVHN/train_val/train_val_img/","D:/data/SVHN/train_val/train_val_voc",)
